	...
	return (
		<div className="relative">
			...
			<div className="relative overflow-hidden rounded-2xl border border-[#29292e] bg-[#121214] p-8">
				...
				<form onSubmit={handleSubmit} className="space-y-5">
					...
					>
						<label className="group flex cursor-pointer items-center gap-2">
							<div className="relative">
								<input
									...
									disabled={isLoading}
								/>
								<div className="h-5 w-5 rounded border-2 border-[#29292e] bg-[#121214] transition-all peer-checked:border-[#8257e5] peer-checked:bg-[#8257e5] group-hover:border-[#8257e5]/50">
									<svg
										className="h-full w-full p-0.5 text-white opacity-0 transition-opacity peer-checked:opacity-100"
										fill="none"
										viewBox="0 0 24 24"
										stroke="currentColor"
										strokeWidth={3}
								...
								<svg
									className={`absolute inset-0 h-full w-full p-0.5 text-white transition-opacity ${
							...
							<span className="text-sm text-[#a9a9b2] transition-colors group-hover:text-[#c4c4cc]">
								Lembrar de mim
							</span>
						</label>
						...
						<Link
							...
							className="text-sm text-[#8257e5] transition-colors hover:text-[#996dff]"
						>
							Esqueceu a senha?
						</Link>
					</motion.div>
				...
				<div className="relative my-8">
					<div className="absolute inset-0 flex items-center">
						<div className="w-full border-t border-[#29292e]" />
					</div>
					<div className="relative flex justify-center text-sm">
						<span className="bg-[#121214] px-4 text-[#7c7c8a]">
							ou continue com
						</span>
					</div>
				</div>
				...
				>
					<EnhancedButton
						type="button"
						variant="outline"
						className="h-11 border-[#29292e] hover:border-[#8257e5]/50 hover:bg-[#8257e5]/5"
						disabled={isLoading}
			...
			<motion.div
				...
				className="mt-6 flex items-center justify-center gap-2 text-xs text-[#7c7c8a]"
			>
				<svg
					className="h-4 w-4 text-[#04d361]"
					fill="none"
					viewBox="0 0 24 24"
					stroke="currentColor"
				>
