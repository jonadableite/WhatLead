...
import { connectInstance, reconnectInstance } from "@/lib/instances/instance-api";
import type { GetInstanceResponse, InstanceListItem } from "@/lib/instances/instance-types";
							...
							<CardContent className="p-6">
								<div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
									...
									<div className="flex flex-col gap-2 sm:flex-row sm:items-center">
										...
										<Link href={`/instances/${encodeURIComponent(item.id)}/health`}>
											<Button>
