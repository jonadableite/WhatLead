	...
	return (
		<div className="relative">
			...
			<div className="relative overflow-hidden rounded-2xl border border-[#29292e] bg-[#121214] p-8">
				...
				<div className="relative my-8">
					...
					<div className="relative flex justify-center text-sm">
						<span className="bg-[#121214] px-4 text-[#7c7c8a]">ou</span>
					</div>
				</div>
				...
				>
					<EnhancedButton
						type="button"
						variant="outline"
						className="h-11 w-full border-[#29292e] hover:border-[#8257e5]/50 hover:bg-[#8257e5]/5"
						disabled={isLoading}
			...
			<motion.p
				...
				className="mt-6 text-center text-xs text-[#7c7c8a]"
			>
				Ao criar uma conta, você concorda com nossos{" "}
				<span className="text-[#8257e5] hover:underline cursor-pointer">
					Termos de Uso
				</span>{" "}
				e{" "}
				<span className="text-[#8257e5] hover:underline cursor-pointer">
