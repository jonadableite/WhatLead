			...
			<div className="relative mx-auto max-w-5xl">
				...
				{isLoading || !data ? (
					...
					<div className="grid gap-4 lg:grid-cols-3">
						<Card className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-xl lg:col-span-2">
							<div className="absolute top-0 left-0 h-[2px] w-full bg-gradient-to-r from-cyan-400 via-violet-500 to-blue-400" />
							<CardContent className="p-6">
								...
								<div className="mt-6">
									<div className="text-sm font-semibold text-white">Ações (domínio)</div>
								...
								<div className="mt-6">
									<div className="text-sm font-semibold text-white">Alertas</div>
						...
						<Card className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-xl">
							<div className="absolute top-0 left-0 h-[2px] w-full bg-gradient-to-r from-cyan-400 via-violet-500 to-blue-400" />
							<CardContent className="p-6">
								<div className="text-sm font-semibold text-white">Signals snapshot</div>
